    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-lg-4 col-md-12 col-sm-12 mt-2">
          <center><img src="../img/jai_hind1.jpg" class="img-fluid        shadow-sm" alt="26jan"></center>
        </div>
        <div class="col-lg-7">
          <center>
            <p class="   shadow-sm p-3     col-md-12 col-sm-12 mt-2">
      ...
      <div class="row">
        <div class="col-lg-4 col-md-12 col-sm-12 mt-2">
          <center><img src="../img/vyash1.jpg" class="img-fluid        shadow-sm " alt="Guru Pornima img"></center>
        </div>
        <div class="col-lg-7">
          <center>
            <p class="   shadow-sm p-3     col-md-12 col-sm-12 mt-2">
      ...
      <div class="row">
        <div class="col-lg-4 col-md-12 col-sm-12 mt-2">
          <center><img src="../img/independance.jpg" class="img-fluid        shadow-sm" alt="independance day"></center>
        </div>
        <div class="col-lg-7">
          <center>
            <p class="   shadow-sm p-3     col-md-12 col-sm-12 mt-2">
      ...
      <div class="row">
        <div class="col-lg-4 col-md-12 col-sm-12 mt-2">
          <center><img src="../img/Mahatma-Gandhi.jpg" height="259" width="250" class="img-fluid        shadow-sm" alt="independance day"></center>
        </div>
        <div class="col-lg-7">
                    <center>
                      <p class="   shadow-sm p-3     col-md-12 col-sm-12 mt-2">
