...
<title>events and Festivals</title>
  ...
  <body class="container-fluid">
    ...
    <div class="container">
      <strong><center><p>Events and Festivals</p></center></strong>
      <!--26 jan republic day-->
      <strong><center><p>Republic Day</p></center></strong>
      <div class="row">
        <div class="col-lg-4 col-md-12 col-sm-12 mt-2">
          <center><img src="../img/jai_hind1.jpg" class="img-fluid rounded-2 shadow-lg" alt="26jan"></center>
        </div>
        <div class="col-lg-7">
          <center>
            <p class="shadow-lg p-3 rounded-2 col-md-12 col-sm-12 mt-2">
            ...
            The date of 26 January was chosen to honour the declaration of independence of 1930. It is one of the three national holidays in India. While the main parade takes place in the national capital, New Delhi, at the Rajpath before the president, the anniversary is also celebrated with varying degrees of formality in state capitals and other centres.
          </p>
          </center>
        </div>
      </div>
      <!-- End 26 jan republic day-->
      <!-- Guru pornima-->
      <strong><center><p>Guru Pornima</p></center></strong>
      <div class="row">
        <div class="col-lg-4 col-md-12 col-sm-12 mt-2">
          <center><img src="../img/vyash1.jpg" class="img-fluid rounded-2 shadow-lg " alt="Guru Pornima img"></center>
        </div>
        <div class="col-lg-7">
          <center>
            <p class="shadow-lg p-3 rounded-2 col-md-12 col-sm-12 mt-2">
      ...
      <!--  End Guru pornima-->
      <!-- independance day-->
      <strong><center><p>Independence Day of India</p></center></strong>
      <div class="row">
        <div class="col-lg-4 col-md-12 col-sm-12 mt-2">
          <center><img src="../img/independance.jpg" class="img-fluid rounded-2 shadow-lg" alt="independance day"></center>
        </div>
        <div class="col-lg-7">
          <center>
            <p class="shadow-lg p-3 rounded-2 col-md-12 col-sm-12 mt-2">
      ...
      <!--  End independance-->
      <!-- GAndhi jayanti-->
      <strong><center><p>Gandhi Jayanti</p></center></strong>
      <div class="row">
        <div class="col-lg-4 col-md-12 col-sm-12 mt-2">
          <center><img src="../img/Mahatma-Gandhi.jpg" height="259" width="250" class="img-fluid rounded-2 shadow-lg" alt="independance day"></center>
        </div>
        <div class="col-lg-7">
                    <center>
                      <p class="shadow-lg p-3 rounded-2 col-md-12 col-sm-12 mt-2">
