...
<html lang="en">
  ...
  <body class="container-fluid">
    ...
    <ul class="nav nav-tabs justify-content-center">
        ...
        <li class="nav-item">
          <a class="nav-link active" aria-current="page" href="Cherekar Makarand..php"><strong>Dr. Cherekar Makarand C.</strong></a>
        </li>
        <li class="nav-item">
...
<div class="container">
    <center><img src="../img/Cherekar (1).jpg" class="img-fluid shadow-lg" height="350" width="450" alt="cherekar sir"></center>
    <center>
        <strong><p class="mt-2">Dr. Cherekar Makarand C.</p></strong>
        <strong><p>Head of Department (Biotechnolgy)</p></strong>
    </center>
    <div class="row gap-5">
        <div class="col-lg-5 shadow-lg rounded-2 mt-2">
            <p>
        ...
        <div class="col-lg-6  shadow-lg rounded-2 mt-2">
            <p>
