...
<div class="container">
    <center><img src="../img/Cherekar (1).jpg" class="img-fluid    shadow-sm" height="350" width="450" alt="cherekar sir"></center>
    <center>
        <strong><p class="mt-2">Dr. Cherekar Makarand C.</p></strong>
        <strong><p>Head of Department (Biotechnolgy)</p></strong>
    </center>
    <div class="row gap-5">
        <div class="col-lg-5    shadow-sm     mt-2">
            <p>
        ...
        <div class="col-lg-6     shadow-sm     mt-2">
            <p>
