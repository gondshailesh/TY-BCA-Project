      ...
      <div class="row">
        ...
        <div  class="col-lg-6 col-sm-12 mt-2  p-3 shadow-lg rounded-2">
            ...
            <p>Last date of schlorship form submission for current academic year will be displayed on notice board.</p>
              ...
              <b><p>Incomplete and late forms will not accepted.</p></b>
            <b><p>NOTE:- CAST VALIDITY IS COMPULSURY FOR ALL APPLICANTS.</p></b>
        </div>
      </div>
            ...
            <div class="row text-sm-center justify-content-center gap-4 text-lg-start text-md-center text-sm-start">
              ...
              <p>3) Previous Sanction No.</p>             
              <p>4) Income Certificate From Tahsildar</p>
              <p>5) Validity Certificate</p>            
              <p>6) Xerox of Fees Receipt</p>
              <p>7) Non Creamy layer</p>              
              <p>8) Gap Certificate (if applicable)</p>
              <p>9) Kutumb Maryada Pramanpatra</p>              
