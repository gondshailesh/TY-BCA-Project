...
<html lang="en">
  ...
  <body class="container-fluid brand-body">
    ...
    <strong><center>Courses Offered</center></strong>
    ...
    <div class="container">
      <div class="row gap-2 ">
        ...
        <div class=" col-lg-7 col-sm-12 p-3 mt-3 res_table">
          <center><strong><caption>B.Sc (Comp.Science) & Bachelor of Computer Application</caption></strong></center>
...
<div class="mt-3"><center><strong><p>Biotechnology & Bioinformatics Courses</p></strong></center></div>
      <div class="row p-3 mt-3    ">
        ...
        <div class="col-lg-6 col-sm-12  p-3 mt-3 res_table">
          <table class="table table-responsive border-primary table-warning ">
            <thead>
              <tr>
                <th>Sr.No.</th>
