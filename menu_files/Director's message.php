  ...
  <body class="container-fluid brand-body">
    ...
    <div class="container">
      <center><strong>Director</strong></center>
        ...
        <div class="row gap-1">
          <div class="col-lg-5    shadow-sm mt-3 p-3    ">
            <p>
          ...
          <div class="col-lg-6    shadow-sm mt-3 p-3    ">
            <p>
