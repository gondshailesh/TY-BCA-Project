  ...
  <body class="container-fluid">
    ...
    <div class="container">
      <center><strong>Director</strong></center>
        <center>    <img src="../img/director-img.jpg" alt="directors message"></center>

        <div class="row gap-1">
          <div class="col-lg-5 shadow-lg mt-3 p-3 rounded-2">
            <p>
          ...
          <div class="col-lg-6 shadow-lg mt-3 p-3 rounded-2">
            <p>
        ...
        <div class="row mt-4 gap-1 ">
          <div class="col-lg-7 rounded-2 shadow-lg p-3 mt-2">      We provide here every opportunity to explore the talents of the student through sports and extra curricular activities which is our USP. Various alumni meets we have had recently in USA in India gave us immense pleasure to be part of career development of success icons, MGM has launch in the open sky of global competition.</div>
          <div class="col-lg-4 rounded-2 shadow-lg p-3 mt-2">
            <b>
          ...
          <p>
            <strong>
              See you in Campus.
                ...
                <p><strong>Dr.Mrs.Geeta S.Lathkar</strong></p>
                <p class="align-content-end">Director</p>
        </div>
