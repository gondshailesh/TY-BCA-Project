    ...
    <div class="container">
      ...
      <div class=" mt-4 table-responsive-lg table-responsive-sm table-responsive-md shadow-lg  text-center">
        ...
        <table class="table table-bordered border-warning table-responsive-lg table-responsive-md table-responsive-sm text-center">
          <thead>
            <tr>
              <th colspan="4">Youth Festival Vilas-2019 Winners</th>
            </tr>
          </thead>
          <tr>
          ...
          <tbody>
            <tr>
            <td>Rushikesh Khanjode</td>
            <td>TYBsc CS</td>
            <td rowspan="6">Skit</td>
            <td rowspan="6">Second</td>
            </tr>
            <tr>
              <td>Ishwar machkatwar</td>
              <td>FYMSc SE</td>
            </tr>
            <tr>
              <td>Vinayak Sorge</td>
            ...
            <tr>
            <td>Akshay Yegaonkar</td>
            <td>TYBsc CS</td>
            <td rowspan="6">Jalsa</td>
            <td rowspan="6">Third</td>
            </tr>
            <tr>
              <td>Kalpesh Rojekar</td>
              <td>YBsc CS</td>
            </tr>
            <tr>
              <td>Sopan Rathod</td>
            ...
            <tr>
              <td>Vijaya Bodhankar</td>
              <td>FYBCA</td>
            </tr>
          </tbody>
        </table>
      </div>
        <!-- End Youth Festival Vilas-2019 Winners-->
