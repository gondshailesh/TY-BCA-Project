    ...
    <div class="row mt-4 justify-content-between">
      ...
      <div class="col-lg-7 mt-4 rounded-2 shadow-lg">
        ...
        <ol type="1">
          ...
          <li>Microprocessor and Micro controller based system development laboratory.</li>
          <li>Power electronics laboratory.</li>
          <li>Optical fiber communication laboratory.</li>
          <li>Microwave communication laboratory.</li>
          <li>Well equipped computer lab.</li>
          <li>Well equipped computer lab.</li>
          <li>Various design softwares.</li>
        </ol>
      </div>
